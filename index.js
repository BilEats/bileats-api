...
app.get("/menu/:day", async (req, res) => {
  try {
    ...
    for (let i = 4; i <= 8; i++) {
      ...
      for (let j = 1; j <= 2; j++) {
        const row = $(
          `body > div > div > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(2) > td > div > table > tbody > tr:nth-child(${
            i + 12 * day
          }) td:nth-child(${j})`
        )
          .text()
    ...
    for (let i = 2; i <= 13; i++) {
      ...
      for (let j = 1; j <= 2; j++) {
        const row = $(
          `body > div > div > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > div > table > tbody > tr:nth-child(${
            i + 12 * day
